    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item ">
	   ...
	   <li class="nav-item active">
        <a class="nav-link" >Discovery Park Home</a>
      </li>
	      <li class="nav-item">
...
<h1 class="title">Discovery Park Devices </h1>
...
$sql = "SELECT * FROM `DiscoDeviceInRack` as rck JOIN DiscoDevices as dev on dev.Serial_Number=rck.Serial_Number order by Location";	
$result = $conn->query($sql);

if ($result->num_rows > 0) {
	//displays table of all devices and allows users to search each field
...
$("#mytable tbody tr").click(function(){
   ...
   window.location.assign("/VueJSProject/discoPark/updateDel.php?serial="+value)
