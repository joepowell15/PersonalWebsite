...
if ($stmt = $mysqli->prepare("Update DiscoDeviceInRack set Location=?,Position=? WHERE Serial_Number=?")) {
...
if ($stmt = $mysqli2->prepare("Update DiscoDevices set Model=?,Manufacturer=?,Grp=?,Owner=? WHERE Serial_Number=?")) {
