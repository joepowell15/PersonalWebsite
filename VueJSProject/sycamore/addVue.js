    ...
    methods: {
        ...
        validSerial: function () {
            ...
            if (!(this.serial)) {
                ...
                xmlhttp.open("GET", "/VueJSProject/sycamore/checkDevice.php?serial=" + this.serial, true);
                xmlhttp.send();
            }
        ...
        validRack: function () {
            ...
            if (!(this.rack)) {
                ...
                xmlhttp.open("GET", "/VueJSProject/sycamore/getRackInfo.php?rack=" + this.rack, true);
                xmlhttp.send();
            }
