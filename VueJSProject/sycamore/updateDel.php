...
<form class="input">
  <div class="form-group" id="formapp">
    ...
    <input v-model="serial"  v-on:blur="validSerial" type="text" class="form-control-plaintext text-light display-4" name="serialnum" placeholder="Enter Serial Number" required>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
 ...
 <script src="/VueJSProject/sycamore/updateVue.js"></script>	
