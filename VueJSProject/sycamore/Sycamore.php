...
<h1 class="title">Sycamore Devices </h1>
...
$sql = "SELECT * FROM `SycamoreDeviceInRack` as rck JOIN SycamoreDevices as dev on dev.Serial_Number=rck.Serial_Number order by Location";	
...
$("#mytable tbody tr").click(function(){
   ...
   window.location.assign("/VueJSProject/sycamore/updateDel.php?serial="+value)
